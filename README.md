...
| :--- | :--- | :--- | :--- |
| **`.exe`** | Ejecutable / Instalador NSIS | [**Descargar Nexo Remote Setup 1.0.0.exe**](https://github.com/raulescobarflores/nexo-remote-releases/releases/download/v1.0.0/Nexo.Remote.Setup.1.0.0.exe) | Usuarios generales (instalación fácil e interactiva). |
| **`.msi`** | Windows Installer | [**Descargar Nexo Remote 1.0.0.msi**](https://github.com/raulescobarflores/nexo-remote-releases/releases/download/v1.0.0/Nexo.Remote.1.0.0.msi) | Despliegues corporativos o instalación silenciosa mediante políticas GPO. |
| **`.appx`** | Paquete de Aplicación de Windows | [**Descargar Nexo Remote 1.0.0.appx**](https://github.com/raulescobarflores/nexo-remote-releases/releases/download/v1.0.0/Nexo.Remote.1.0.0.appx) | Carga local (sideloading) o pruebas previas a la Microsoft Store. |
...
1. Descarga el archivo [Nexo.Remote.Setup.1.0.0.exe](https://github.com/raulescobarflores/nexo-remote-releases/releases/download/v1.0.0/Nexo.Remote.Setup.1.0.0.exe).
...
1. Descarga [Nexo.Remote.1.0.0.msi](https://github.com/raulescobarflores/nexo-remote-releases/releases/download/v1.0.0/Nexo.Remote.1.0.0.msi).
2. Ejecuta el archivo para instalar la aplicación.
...
1. Descarga el paquete [Nexo.Remote.1.0.0.appx](https://github.com/raulescobarflores/nexo-remote-releases/releases/download/v1.0.0/Nexo.Remote.1.0.0.appx).
